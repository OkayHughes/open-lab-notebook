...
`$$$
\begin{align*}
    &\int \int p\hat{r}^2\delta[\partial_{\eta}[\phi]] + \textrm{BC} -\hat{r}^2 \partial_{\eta} [p] \delta \phi  \intd{\eta} \intd{A} =  \int \int p\hat{r}^2\delta[\partial_{\eta}[\phi]] + \textrm{BC} -\hat{r}^2 \partial_{\eta} [p] \delta \phi  \intd{\eta} \intd{A} = 0\\
\end{align*}
$$$`
and so
